---
title: "An overview of TDIP's functionalities"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstration of the functionalities of the TDIP package}
...
2. To use GAIN, python needs to be installed as well as the `tensorflow`, `numpy`, `scikit-learn` and `tqdm` packages. The R package `reticulate` provide all the commands needed.
```{r, eval = FALSE}
...
#Conda environement
reticulate::conda_install("TensorEnv",c("tensorflow", "numpy", "scikit-learn", "tqdm"))

#Pip
reticulate::py_install(c("tensorflow", "numpy", "scikit-learn", "tqdm"), pip = TRUE)
```
